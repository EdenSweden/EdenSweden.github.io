...
return(
    ...
    <div id='intro-content'>
            <p className='intro-text' id='p1'> Hi, I'm Eden. I am a self-taught front-end web developer from Utah, currently based in Brisbane, Australia. I come from a social sciences background, but I decided to pursue coding!</p>
